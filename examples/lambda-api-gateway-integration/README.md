# DuploCloud lambda Module with different integrations like API Gateway and Cloudwatch Events 

This example demonstrates how to deploy a lambda function with API Gateway or Cloudwatch Events integration. 
